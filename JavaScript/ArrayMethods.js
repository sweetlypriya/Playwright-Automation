...
console.log(toolsAutomation.indexOf("QTP")) //it returns index as -1 if the value is not present in array

//7)array.concat() => it is used to merge two or more arrays
//it doesnt modifies in the original array instead it stores in new array
console.log("==========CONCAT=======")
...
console.log(nestedItems.flat(1)) //flatten 1 nested array
console.log(nestedItems.flat(2)) //flatten 2 nested array
console.log(nestedItems.flat(Infinity)) //flatten all the nested array available

//10)array.join() => join the elements of the array into a string
console.log("=========JOIN========")

console.log(toolsAutomation.join(",")) //it join array into string using "," eg: "PlayWright,Selenium,Tosca,Cypress,Pupeteer"
console.log(toolsAutomation.join()) //by default it will join usin ","
console.log(toolsAutomation.join("_")) //it join array into string using "_" eg: "PlayWright_Selenium_Tosca_Cypress_Pupeteer"
